...
*Default Lab*  
2 API - 172.29.176.20-21 (Not Used)
3 Infra - 172.29.176.30-32  
2 Network - 172.29.176.40-42  
...
neutron subnet-create ext-net 10.168.231.0/24 --name ext-subnet --gateway=10.168.231.1 --allocation-pool start=10.168.231.11,end=10.168.231.254 --enable_dhcp=false  
neutron net-create --provider:physical_network=vlan --provider:network_type=vlan --provider:segmentation_id=206 --shared int-net  
neutron subnet-create int-net 10.168.241.0/24 --name int-subnet --dns-nameservers list=true 8.8.8.8 8.8.4.4  
