# WIP (DRAFT STATUS)
<span style="color: red; background-color: black;"><b>Currently there is an issue upstream that if you reboot
...
lxc-system-manage system-rebuild - resolves it.</b></span>
